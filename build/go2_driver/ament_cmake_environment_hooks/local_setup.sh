...
: ${AMENT_CURRENT_PREFIX:="/home/jnu/go2_ws/install/go2_driver"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_driver/environment/library_path.sh"
