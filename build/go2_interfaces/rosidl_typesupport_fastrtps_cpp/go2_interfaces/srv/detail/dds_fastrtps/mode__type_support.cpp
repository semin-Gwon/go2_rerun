...
#include "go2_interfaces/srv/detail/mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const go2_interfaces::srv::Mode_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  go2_interfaces::srv::Mode_Request & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces::srv::Mode_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const go2_interfaces::srv::Mode_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<go2_interfaces::srv::Mode_Request *>(
    untyped_ros_message);
...
{
  return &go2_interfaces::srv::typesupport_fastrtps_cpp::_Mode_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, go2_interfaces, srv, Mode_Request)() {
  return &go2_interfaces::srv::typesupport_fastrtps_cpp::_Mode_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_go2_interfaces
cdr_serialize(
  const go2_interfaces::srv::Mode_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  go2_interfaces::srv::Mode_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = go2_interfaces::srv::Mode_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const go2_interfaces::srv::Mode_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<go2_interfaces::srv::Mode_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &go2_interfaces::srv::typesupport_fastrtps_cpp::_Mode_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, go2_interfaces, srv, Mode_Response)() {
  return &go2_interfaces::srv::typesupport_fastrtps_cpp::_Mode_Response__handle;
}
...
{
  return &go2_interfaces::srv::typesupport_fastrtps_cpp::_Mode__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, go2_interfaces, srv, Mode)() {
  return &go2_interfaces::srv::typesupport_fastrtps_cpp::_Mode__handle;
}
