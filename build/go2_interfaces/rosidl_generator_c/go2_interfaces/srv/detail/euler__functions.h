...
#ifndef GO2_INTERFACES__SRV__DETAIL__EULER__FUNCTIONS_H_
#define GO2_INTERFACES__SRV__DETAIL__EULER__FUNCTIONS_H_
...
/// Create srv/Euler message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * go2_interfaces__srv__Euler_Request__init().
...
/// Destroy srv/Euler message.
/**
 * It calls
 * go2_interfaces__srv__Euler_Request__fini()
...
/// Check for srv/Euler message equality.
/**
...
/// Initialize array of srv/Euler messages.
/**
...
/// Finalize array of srv/Euler messages.
/**
 * It calls
 * go2_interfaces__srv__Euler_Request__fini()
...
/// Create array of srv/Euler messages.
/**
 * It allocates the memory for the array and calls
 * go2_interfaces__srv__Euler_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Euler messages.
/**
 * It calls
 * go2_interfaces__srv__Euler_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Euler message array equality.
/**
...
/// Copy an array of srv/Euler messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * go2_interfaces__srv__Euler_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_go2_interfaces
...
/**
 * It calls
 * go2_interfaces__srv__Euler_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_go2_interfaces
...
/**
 * It allocates the memory for the array and calls
 * go2_interfaces__srv__Euler_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_go2_interfaces
...
/**
 * It calls
 * go2_interfaces__srv__Euler_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GO2_INTERFACES__SRV__DETAIL__EULER__FUNCTIONS_H_
