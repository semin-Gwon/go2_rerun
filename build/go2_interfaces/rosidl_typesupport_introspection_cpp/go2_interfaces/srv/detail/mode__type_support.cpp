...
{
  new (message_memory) go2_interfaces::srv::Mode_Request(_init);
}

void Mode_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<go2_interfaces::srv::Mode_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Mode_Request_message_member_array[1] = {
  {
    ...
    offsetof(go2_interfaces::srv::Mode_Request, mode),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Mode_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(go2_interfaces::srv::Mode_Request),
...
{
  return &::go2_interfaces::srv::rosidl_typesupport_introspection_cpp::Mode_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, go2_interfaces, srv, Mode_Request)() {
  return &::go2_interfaces::srv::rosidl_typesupport_introspection_cpp::Mode_Request_message_type_support_handle;
}
...
void Mode_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) go2_interfaces::srv::Mode_Response(_init);
}

void Mode_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<go2_interfaces::srv::Mode_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Mode_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::srv::Mode_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::srv::Mode_Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Mode_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(go2_interfaces::srv::Mode_Response),
...
{
  return &::go2_interfaces::srv::rosidl_typesupport_introspection_cpp::Mode_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, go2_interfaces, srv, Mode_Response)() {
  return &::go2_interfaces::srv::rosidl_typesupport_introspection_cpp::Mode_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Mode_service_members = {
  ...
  // see get_service_type_support_handle<go2_interfaces::srv::Mode>()
...
get_service_type_support_handle<go2_interfaces::srv::Mode>()
{
  ...
  auto service_type_support =
    &::go2_interfaces::srv::rosidl_typesupport_introspection_cpp::Mode_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::go2_interfaces::srv::Mode_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::go2_interfaces::srv::Mode_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, go2_interfaces, srv, Mode)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<go2_interfaces::srv::Mode>();
}
