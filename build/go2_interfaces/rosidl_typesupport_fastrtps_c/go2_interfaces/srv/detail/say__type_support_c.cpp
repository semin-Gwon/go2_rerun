...
#include "go2_interfaces/srv/detail/say__rosidl_typesupport_fastrtps_c.h"
...
using _Say_Request__ros_msg_type = go2_interfaces__srv__Say_Request;
...
size_t get_serialized_size_go2_interfaces__srv__Say_Request(
  const void * untyped_ros_message,
...
static uint32_t _Say_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__srv__Say_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_go2_interfaces__srv__Say_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces__srv__Say_Request;
    is_plain =
      (
...
static size_t _Say_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__srv__Say_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, srv, Say_Request)() {
...
using _Say_Response__ros_msg_type = go2_interfaces__srv__Say_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t get_serialized_size_go2_interfaces__srv__Say_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Say_Response__ros_msg_type * ros_message = static_cast<const _Say_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__srv__Say_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_go2_interfaces__srv__Say_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = go2_interfaces__srv__Say_Response;
    is_plain =
      (
...
static size_t _Say_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__srv__Say_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, srv, Say_Response)() {
...
// already included above
// #include "go2_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "go2_interfaces/srv/say.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, srv, Say)() {
  return &Say__handle;
}
