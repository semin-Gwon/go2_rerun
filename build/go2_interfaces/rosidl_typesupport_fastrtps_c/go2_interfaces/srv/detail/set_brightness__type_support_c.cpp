...
#include "go2_interfaces/srv/detail/set_brightness__rosidl_typesupport_fastrtps_c.h"
...
using _SetBrightness_Request__ros_msg_type = go2_interfaces__srv__SetBrightness_Request;
...
size_t get_serialized_size_go2_interfaces__srv__SetBrightness_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetBrightness_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__srv__SetBrightness_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_go2_interfaces__srv__SetBrightness_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces__srv__SetBrightness_Request;
    is_plain =
      (
...
static size_t _SetBrightness_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__srv__SetBrightness_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, srv, SetBrightness_Request)() {
...
using _SetBrightness_Response__ros_msg_type = go2_interfaces__srv__SetBrightness_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t get_serialized_size_go2_interfaces__srv__SetBrightness_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetBrightness_Response__ros_msg_type * ros_message = static_cast<const _SetBrightness_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__srv__SetBrightness_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_go2_interfaces__srv__SetBrightness_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = go2_interfaces__srv__SetBrightness_Response;
    is_plain =
      (
...
static size_t _SetBrightness_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__srv__SetBrightness_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, srv, SetBrightness_Response)() {
...
// already included above
// #include "go2_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "go2_interfaces/srv/set_brightness.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, srv, SetBrightness)() {
