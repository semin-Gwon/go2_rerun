...
#include "go2_interfaces/srv/detail/get_state__rosidl_typesupport_fastrtps_c.h"
...
using _GetState_Request__ros_msg_type = go2_interfaces__srv__GetState_Request;
...
size_t get_serialized_size_go2_interfaces__srv__GetState_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetState_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__srv__GetState_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_go2_interfaces__srv__GetState_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces__srv__GetState_Request;
    is_plain =
      (
...
static size_t _GetState_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__srv__GetState_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, srv, GetState_Request)() {
...
using _GetState_Response__ros_msg_type = go2_interfaces__srv__GetState_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t get_serialized_size_go2_interfaces__srv__GetState_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetState_Response__ros_msg_type * ros_message = static_cast<const _GetState_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__srv__GetState_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_go2_interfaces__srv__GetState_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = go2_interfaces__srv__GetState_Response;
    is_plain =
      (
...
static size_t _GetState_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__srv__GetState_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, srv, GetState_Response)() {
...
// already included above
// #include "go2_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "go2_interfaces/srv/get_state.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, srv, GetState)() {
