...
inline void to_flow_style_yaml(
  const ContinuousGait_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: flag
...
inline std::string to_yaml(const ContinuousGait_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const go2_interfaces::srv::ContinuousGait_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const go2_interfaces::srv::ContinuousGait_Request & msg)
{
...
inline void to_flow_style_yaml(
  const ContinuousGait_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: success
...
inline std::string to_yaml(const ContinuousGait_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use go2_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const go2_interfaces::srv::ContinuousGait_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  go2_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use go2_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const go2_interfaces::srv::ContinuousGait_Response & msg)
{
  return go2_interfaces::srv::to_yaml(msg);
}
