...
class Metaclass_Mode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from go2_interfaces.srv import _mode
...
class Mode(metaclass=Metaclass_Mode):
    from go2_interfaces.srv._mode import Mode_Request as Request
    from go2_interfaces.srv._mode import Mode_Response as Response
