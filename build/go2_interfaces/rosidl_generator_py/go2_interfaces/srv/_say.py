...
class Metaclass_Say(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from go2_interfaces.srv import _say
...
class Say(metaclass=Metaclass_Say):
    from go2_interfaces.srv._say import Say_Request as Request
    from go2_interfaces.srv._say import Say_Response as Response
