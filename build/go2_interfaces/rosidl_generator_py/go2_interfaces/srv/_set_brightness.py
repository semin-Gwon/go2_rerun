...
class Metaclass_SetBrightness(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'go2_interfaces.srv.SetBrightness')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from go2_interfaces.srv import _set_brightness
...
class SetBrightness(metaclass=Metaclass_SetBrightness):
    from go2_interfaces.srv._set_brightness import SetBrightness_Request as Request
    from go2_interfaces.srv._set_brightness import SetBrightness_Response as Response
