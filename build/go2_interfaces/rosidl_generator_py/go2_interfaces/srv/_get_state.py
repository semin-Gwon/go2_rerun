...
class Metaclass_GetState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from go2_interfaces.srv import _get_state
...
class GetState(metaclass=Metaclass_GetState):
    from go2_interfaces.srv._get_state import GetState_Request as Request
    from go2_interfaces.srv._get_state import GetState_Response as Response
